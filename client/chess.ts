...
export const BOARD_FAMILIES: { [key: string]: BoardFamily } = {
    ...
    janggi9x10: { dimensions: { width: 9, height: 10 }, cg: "cg-576-640", boardCSS: ["JanggiBrown.svg", "JanggiPaper.png", "JanggiWood.png", "JanggiDark.svg", "JanggiWoodDark.svg", "JanggiStone.svg", "Janggi.svg"] },
    janggi5x7: { dimensions: { width: 5, height: 7 }, cg: "cg-260-448", boardCSS: ["komajanggi.svg"] },	
    ...
    pandemonium9x9: { dimensions: { width: 9, height: 9 }, cg: "cg-540", boardCSS: ["9x9pandemonium.svg", "ShogiBlueTexture1.svg", "ShogiCheckeredWood1.svg", "ShogiGrayTexture1.svg", "ShogiGreenTexture1.svg", "ShogiMaple1.svg", "ShogiRedTexture1.svg", "ShogiSpace11.svg"] },
};
...
export const VARIANTS: { [name: string]: Variant } = {
    ...
    promojanggi: new Variant({
        ...
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "+c", "b", "+b", "n", "+n", "p", "+p", "r", "+r"],
        promotion: "shogi",			
        promoteableLetters: ["c", "b", "n", "p", "r"],
        //isMandatoryPromotion: distanceBased({ p: 1, b: 1, n: 1, c: 1, r: 1 }, 10),		
        timeControl: "byoyomi",
        materialPoint: "janggi",
        // showPromoted: true,	
        pieceSound: "shogi",		
    ...
    racingjanggi: new Variant({
        name: "racingjanggi", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
    ...
    allracingjanggi: new Variant({
        name: "allracingjanggi", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],	
    ...
    chessjanggi: new Variant({
        name: "chessjanggi", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
    ...
    hpjanggi: new Variant({
        name: "hpjanggi", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
    ...
    nzjanggi: new Variant({
        name: "nzjanggi", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
    ...
    nnjanggi: new Variant({
        name: "nnjanggi", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
    ...
    atomicjanggihouse: new Variant({
        name: "atomicjanggihouse", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. "),
        startFen: "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR[] w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
    ...
    janggimodern: new Variant({
        name: "janggimodern", displayName: "카카오장기", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
        ...
        alternateStart: {
            '': '',
            '초:마상상마 한:마상상마': "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",			
            '초:마상상마 한:마상마상': "rnba1anbr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",
            '초:마상상마 한:상마상마': "rbna1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",			
            '초:마상상마 한:상마마상': "rbna1anbr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ABNR w - - 0 1",			
            '초:마상마상 한:마상상마': "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ANBR w - - 0 1",
            '초:마상마상 한:마상마상': "rnba1anbr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ANBR w - - 0 1",
            '초:마상마상 한:상마상마': "rbna1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ANBR w - - 0 1",
            '초:마상마상 한:상마마상': "rbna1anbr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ANBR w - - 0 1",			
            '초:상마상마 한:마상상마': "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RBNA1ABNR w - - 0 1",
            '초:상마상마 한:마상마상': "rnba1anbr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RBNA1ABNR w - - 0 1",
            '초:상마상마 한:상마상마': "rbna1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RBNA1ABNR w - - 0 1",
            '초:상마상마 한:상마마상': "rbna1anbr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RBNA1ABNR w - - 0 1",			
            '초:상마마상 한:마상상마': "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RBNA1ANBR w - - 0 1",
            '초:상마마상 한:마상마상': "rnba1anbr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RBNA1ANBR w - - 0 1",
            '초:상마마상 한:상마상마': "rbna1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RBNA1ANBR w - - 0 1",
            '초:상마마상 한:상마마상': "rbna1anbr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RBNA1ANBR w - - 0 1"            
        },
        pass: true,
        icon: "=",
    }),
    ...
    komajanggi: new Variant({
        name: "komajanggi", tooltip: () => _("Compact version of Janggi played on a 7x7 board without a river."),
        startFen: "rn1nr/2k2/p1p1p/5/P1P1P/2K2/RN1NR w - - 0 1",
        board: "janggi5x7", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "r", "n", "p"],
        promoteableLetters: [],
        timeControl: "byoyomi",
        materialPoint: "janggi",
        pass: true,			
    ...
    komajanggihouse: new Variant({
        name: "komajanggihouse", tooltip: () => _("Compact version of Janggi played on a 7x7 board without a river."),
        startFen: "rn1nr/2k2/p1p1p/5/P1P1P/2K2/RN1NR[] w - - 0 1",
        board: "janggi5x7", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "r", "n", "p"],
    ...
    nudejanggihouse: new Variant({
        name: "nudejanggihouse", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "9/4k4/9/9/9/9/9/9/4K4/9[RRNNBBCCAAPPPPPrrnnbbccaappppp] w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
    ...
    pocketjanggi: new Variant({
        name: "pocketjanggi", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "3a1a3/4k4/9/p1p1p1p1p/9/9/P1P1P1P1P/9/4K4/3A1A3[RRNNBBCCrrnnbbcc] w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
        pocketLetters: ["c", "r", "b", "n"],		
        promoteableLetters: [],
        timeControl: "byoyomi",
        materialPoint: "janggi",
        pass: true,
    ...
    pocketjanggil: new Variant({
        name: "pocketjanggil", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "3a1a3/4k4/9/p1p1p1p1p/9/9/P1P1P1P1P/9/4K4/3A1A3[RRNNBBCCrrnnbbcc] w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
    ...
    pocketjanggip: new Variant({
        name: "pocketjanggip", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "3a1a3/4k4/9/2p1p1p2/9/9/2P1P1P2/9/4K4/3A1A3[RRNNBBCCPPrrnnbbccpp] w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
        pocketLetters: ["c", "r", "b", "n", "p"],		
        promoteableLetters: [],
        timeControl: "byoyomi",
        materialPoint: "janggi",
        pass: true,
    ...
    pocketjanggihouse: new Variant({
        name: "pocketjanggihouse", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "3a1a3/4k4/9/p1p1p1p1p/9/9/P1P1P1P1P/9/4K4/3A1A3[RRNNBBCCrrnnbbcc] w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
    ...
    pocketjanggilhouse: new Variant({
        name: "pocketjanggilhouse", tooltip: () => _("Korean Chess, similar to Xiangqi but plays much differently. Tournament rules are used."),
        startFen: "3a1a3/4k4/9/p1p1p1p1p/9/9/P1P1P1P1P/9/4K4/3A1A3[RRNNBBCCrrnnbbcc] w - - 0 1",
        board: "janggi9x10", piece: "janggi",
        firstColor: "Blue", secondColor: "Red",
        pieceLetters: ["k", "a", "c", "r", "b", "n", "p"],
...
const variantGroups: { [ key: string ]: { variants: string[] } } = {
    xiangqi:  { variants: ["janggi", "komajanggi", "komajanggihouse", "promojanggi", "janggimodern", "racingjanggi", "allracingjanggi", "hpjanggi", "nzjanggi", "nnjanggi", "chessjanggi",  "chessjanggihouse",  "centerjanggi",  "nudejanggi", "nudejanggihouse", "pocketjanggi", "pocketjanggil", "pocketjanggip", "pocketjanggihouse", "pocketjanggilhouse", "check3janggi", "check3janggihouse", "atomicjanggi", "atomicjanggihouse", "minijanggi", "minijanggihouse", "changgi", "racingkingsjanggi" , "coffeejanggi", "coffeejanggihouse", "janggihouse", "janggilhouse", "minixiangqi" , "xiangqi", "manchu"] },
...
export function notation(variant: Variant): cg.Notation {
    ...
    switch (variant.name) {
        ...
        case 'pocketjanggil':
        case 'pocketjanggip':		
        case 'pocketjanggihouse':
        case 'pocketjanggilhouse':		
        case 'check3janggi':
